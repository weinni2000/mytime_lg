...
class WhatsAppAccount(models.Model):
    ...
    def _start_private_listener(self):
        ...
        # Written before the worker starts so it can read the same secret
        # and push new messages to Odoo immediately instead of only relying
        # on the once-a-minute cron.
        self.private_company_id._whatsapp_private_notify_token()
        command = [
            sys.executable,
