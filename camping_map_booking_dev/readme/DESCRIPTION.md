...
as regular data records instead - so the `camping_checkout` pitch selection
step has something real to show and click through on install, on a database
where demo data isn't loaded.
